...
import { createEvaluation, getPendingSubmissions, getStudentEvaluations, listEvaluations, } from '../controllers/evaluationController.js';
import { authenticate, authorize } from '../middleware/auth.js';
import { validate } from '../middleware/validate.js';
import { asyncHandler } from '../utils/asyncHandler.js';
const router = Router();
router.get('/pending', authenticate, authorize('admin', 'evaluator'), asyncHandler(getPendingSubmissions));
router.post('/', authenticate, authorize('admin', 'evaluator'), [
